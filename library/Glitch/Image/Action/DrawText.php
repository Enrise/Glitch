...
class Glitch_Image_Action_DrawText extends Glitch_Image_Action_ActionAbstract {
/**
 ...
 */
     ...
     * @throw Glitch_Image_Exception
     * @return this
     */
    public function setFont($fontPath) {
        if(!file_exists($fontPath)) {
            // require_once 'Zend/Image/Exception.php';
            throw new Glitch_Image_Exception('Incorrect font');
        }
        $this->_font = $fontPath;
    }
